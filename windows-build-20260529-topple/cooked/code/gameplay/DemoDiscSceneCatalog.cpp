...
Array<::MenuItemDefinition*> *items = new Array<MenuItemDefinition*>(physicsSceneEntries->Count() + 1);
for (int32_t index = 0; index < physicsSceneEntries->Count(); index++) {
::DemoDiscPhysicsSceneEntry *sceneEntry = (*physicsSceneEntries)[index];
(*items)[index] = ([&]() {
auto __ctor_arg_00000028 = sceneEntry->get_MenuItemId();
auto __ctor_arg_00000029 = sceneEntry->get_DisplayName();
auto __ctor_arg_0000002A = true;
auto __ctor_arg_0000002B = new ::MenuActionDefinition(MenuActionKind::LoadScene, sceneEntry->get_SceneId());
return new ::MenuItemDefinition(__ctor_arg_00000028, __ctor_arg_00000029, __ctor_arg_0000002A, __ctor_arg_0000002B);
})();
}
(*items)[physicsSceneEntries->Count()] = ([&]() {
