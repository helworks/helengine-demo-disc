...
bool DemoScenePlatformInstructionIconSetComponent::ContainsNormalizedPlatformToken(std::string normalizedPlatformName, std::string token)
{
    ...
    {
throw ([&]() {
auto __ctor_arg_00000094 = "Normalized platform name must be provided.";
auto __ctor_arg_00000095 = "normalizedPlatformName";
return new ArgumentException(__ctor_arg_00000094, __ctor_arg_00000095);
    ...
    {
throw ([&]() {
auto __ctor_arg_00000096 = "Platform token must be provided.";
auto __ctor_arg_00000097 = "token";
...
int32_t DemoScenePlatformInstructionIconSetComponent::ResolveSelectedGroupIndex(std::string platformName)
{
    ...
    {
throw ([&]() {
auto __ctor_arg_00000098 = "Platform name must be provided.";
auto __ctor_arg_00000099 = "platformName";
return new ArgumentException(__ctor_arg_00000098, __ctor_arg_00000099);
})();
    }
