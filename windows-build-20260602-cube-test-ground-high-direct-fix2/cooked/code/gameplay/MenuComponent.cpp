...
throw new ArgumentNullException("panelRuntime");
    ...
    {
throw ([&]() {
auto __ctor_arg_0000009A = "selectedItemIndex";
...
throw new ArgumentNullException("panelRuntime");
    ...
    {
throw ([&]() {
auto __ctor_arg_0000009C = "itemIndex";
auto __ctor_arg_0000009D = "Selected baked menu item index must be valid.";
return new ArgumentOutOfRangeException(__ctor_arg_0000009C, __ctor_arg_0000009D);
})();
    }
