...
int32_t DemoScenePlatformInstructionIconSetComponent::Ps2GroupChildIndex = 1;

int32_t DemoScenePlatformInstructionIconSetComponent::SwitchGroupChildIndex = 2;

int32_t DemoScenePlatformInstructionIconSetComponent::Xbox360GroupChildIndex = 0;
...
Entity *childEntity = (*this->OwnerEntity->get_Children())[childIndex];
