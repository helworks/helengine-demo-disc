...
### Change
Update the four dynamic stack-box entities in `C:\dev\helprojs\demodisc\assets\codebase\physics.tools\PhysicsSceneFactory.cs` to use X positions `0.0f`, `0.2f`, `0.4f`, and `0.6f` while preserving their current Y heights, Z positions, body types, and materials.
