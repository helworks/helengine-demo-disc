namespace city.menu {
    ...
    public sealed class MenuDefinition {
        ...
        public MenuDefinition(
            ...
            [NativeTakesOwnership] MenuPanelDefinition[] panels,
            [NativeTakesOwnership] MenuOverlayImageDefinition overlayImage = null,
            [NativeTakesOwnership] MenuPlatformInfoDefinition platformInfoOverlay = null) {
            if (title == null) {
