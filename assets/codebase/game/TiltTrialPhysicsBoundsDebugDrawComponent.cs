...
#else
    /// <summary>
    /// Preserves the serialized bounds-debug component reference outside debug desktop builds without retaining its shader-backed diagnostic implementation.
    /// </summary>
    public sealed class TiltTrialPhysicsBoundsDebugDrawComponent : UpdateComponent {
        /// <summary>
        /// Gets whether the debug-only diagnostic overlay is visible on this runtime.
        /// </summary>
