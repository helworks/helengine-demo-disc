    ...
    public sealed class DemoDiscSceneCatalog {
        ...
        public MenuItemDefinition[] CreateSceneItems() {
            return new[] {
                ...
                new MenuItemDefinition("scene-axis-test", "Axis Test", "Three-axis rotation validation scene with a directional-light arrow.", true, new MenuActionDefinition(MenuActionKind.LoadScene, "axis_test")),
                new MenuItemDefinition("scene-axis-test-2", "Axis Test 2", "Mirrored axis showcase that validates the right-side directional layout.", true, new MenuActionDefinition(MenuActionKind.LoadScene, "axis_test2")),
                ...
                new MenuItemDefinition("scene-spotlight-street-slice", "Spotlight Street Slice", "Street-lit showcase that validates spotlights and prop placement.", true, new MenuActionDefinition(MenuActionKind.LoadScene, "spotlight_street_slice")),
