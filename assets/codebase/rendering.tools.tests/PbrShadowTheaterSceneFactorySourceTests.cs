namespace city.tests {
    public sealed class PbrShadowTheaterSceneFactorySourceTests {
        ...
        public void Shadow_theater_scene_factory_declares_its_scene_id_and_two_shadow_casting_lights() {
            ...
            Assert.Contains("public GeneratedAuthoringSceneDefinition CreateSceneDefinition(string projectRootPath, RuntimeModel cubeModel, RuntimeModel sphereModel, RuntimeMaterial pedestalMaterial, RuntimeMaterial[] galleryMaterials)", source, StringComparison.Ordinal);
