...
namespace city.rendering.tools {
    /// <summary>
    /// Builds the live-authored axis-test scene and its generated directional-light arrow model.
    /// </summary>
    public sealed class AxisTestSceneFactory {
        ...
        public AxisTestSceneFactory(IEditorProjectAuthoringSession assetAuthoringService, EditorAuthoringTransaction transaction) {
        ...
        /// <summary>
        /// Creates the generated directional-light arrow runtime model used by the live-authored axis-test scene.
        /// </summary>
        ...
        /// <summary>
        /// Creates the authored camera entity for the live axis-test scene.
        /// </summary>
        ...
        /// <summary>
        /// Creates the authored directional-light rig entity for the live axis-test scene.
        /// </summary>
        /// <param name="arrowModel">Runtime model used by the directional-light arrow.</param>
        ...
        /// <summary>
        /// Creates the authored directional-light arrow entity for the live axis-test scene.
        /// </summary>
        ...
        /// <summary>
        /// Creates the authored X-axis mesh entity for the live axis-test scene.
        /// </summary>
        ...
        Entity CreateXAxisEntity(RuntimeModel model, RuntimeMaterial material) {
            return CreateAxisEntity("AxisTestXAxis", new float3(5f, 0f, 0f), new float3(10f, 0.5f, 0.5f), model, material);
        }

        /// <summary>
        /// Creates the authored Y-axis mesh entity for the live axis-test scene.
        /// </summary>
        /// <param name="model">Generated cube runtime model used by the mesh.</param>
        ...
        Entity CreateYAxisEntity(RuntimeModel model, RuntimeMaterial material) {
            return CreateAxisEntity("AxisTestYAxis", new float3(0f, 5f, 0f), new float3(0.5f, 10f, 0.5f), model, material);
        }

        /// <summary>
        /// Creates the authored Z-axis mesh entity for the live axis-test scene.
        /// </summary>
        /// <param name="model">Generated cube runtime model used by the mesh.</param>
        ...
        Entity CreateZAxisEntity(RuntimeModel model, RuntimeMaterial material) {
            return CreateAxisEntity("AxisTestZAxis", new float3(0f, 0f, 5f), new float3(0.5f, 0.5f, 10f), model, material);
        }

        /// <summary>
        /// Creates the authored floor entity for the live axis-test scene.
        /// </summary>
        /// <param name="model">Generated cube runtime model used by the mesh.</param>
        ...
        Entity CreateFloorEntity(RuntimeModel model, RuntimeMaterial material) {
            return CreateAxisEntity("AxisTestFloor", new float3(5f, -5f, 5f), new float3(14f, 0.5f, 14f), model, material);
        }

        /// <summary>
        /// Creates the authored ground entity for the live axis-test scene.
        /// </summary>
        /// <param name="model">Generated cube runtime model used by the mesh.</param>
        /// <param name="material">Runtime ground material.</param>
        /// <returns>Live authored ground entity.</returns>
        Entity CreateGroundEntity(RuntimeModel model, RuntimeMaterial material) {
            return CreateAxisEntity("AxisTestGround", new float3(5f, 5f, -5f), new float3(14f, 14f, 0.5f), model, material);
        }

        /// <summary>
        /// Creates the authored origin marker entity for the live axis-test scene.
        /// </summary>
        /// <param name="model">Generated cube runtime model used by the mesh.</param>
        ...
        Entity CreateOriginMarkerEntity(RuntimeModel model, RuntimeMaterial material) {
            return CreateAxisEntity("AxisTestOriginMarker", float3.Zero, new float3(0.5f, 0.5f, 0.5f), model, material);
        }

        /// <summary>
        /// Creates the authored X-axis marker entity for the live axis-test scene.
        /// </summary>
        /// <param name="model">Generated cube runtime model used by the mesh.</param>
        /// <param name="material">Runtime marker material.</param>
        ...
        Entity CreateXAxisMarkerEntity(RuntimeModel model, RuntimeMaterial material) {
            return CreateAxisEntity("AxisTestXAxisMarker", new float3(5f, 0f, 0f), new float3(0.35f, 0.35f, 0.35f), model, material);
        }

        /// <summary>
        /// Creates the authored Y-axis marker entity for the live axis-test scene.
        /// </summary>
        /// <param name="model">Generated cube runtime model used by the mesh.</param>
        /// <param name="material">Runtime marker material.</param>
        ...
        Entity CreateYAxisMarkerEntity(RuntimeModel model, RuntimeMaterial material) {
            return CreateAxisEntity("AxisTestYAxisMarker", new float3(0f, 5f, 0f), new float3(0.35f, 0.35f, 0.35f), model, material);
        }

        /// <summary>
        /// Creates the authored Z-axis marker entity for the live axis-test scene.
        /// </summary>
        /// <param name="model">Generated cube runtime model used by the mesh.</param>
        /// <param name="material">Runtime marker material.</param>
        ...
        Entity CreateZAxisMarkerEntity(RuntimeModel model, RuntimeMaterial material) {
            return CreateAxisEntity("AxisTestZAxisMarker", new float3(0f, 0f, 5f), new float3(0.35f, 0.35f, 0.35f), model, material);
        }

        /// <summary>
        /// Creates one shared mesh entity for the axis-test showcase.
        /// </summary>
