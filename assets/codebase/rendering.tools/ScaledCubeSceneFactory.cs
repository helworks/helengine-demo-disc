...
namespace city.rendering.tools {
    ...
    public sealed class ScaledCubeSceneFactory {
        ...
        public ScaledCubeSceneFactory(IEditorProjectAuthoringSession assetAuthoringService, EditorAuthoringTransaction transaction) {
        ...
        Entity CreateUiEntity() {
            return new DemoDiscSceneUiKitFactory(AssetAuthoringService).CreateStandardSceneUi("ScaledCubeUi", string.Empty);
        }
