...
namespace city.rendering.tools {
    ...
    public sealed class AxisTest2SceneFactory {
        ...
        public AxisTest2SceneFactory(IEditorProjectAuthoringSession assetAuthoringService, EditorAuthoringTransaction transaction) {
        ...
        Entity CreateCameraEntity() {
            ...
            Entity entity = AssetAuthoringService.OwningCore.EntityFactory.Create("AxisTest2Camera");
        ...
        Entity CreateDirectionalLightRigEntity(string projectRootPath, RuntimeModel arrowModel, RuntimeMaterial markerMaterial) {
            ...
            Entity entity = AssetAuthoringService.OwningCore.EntityFactory.Create("AxisTest2SunRig");
        ...
        Entity CreateDirectionalLightArrowEntity(string projectRootPath, RuntimeModel arrowModel, RuntimeMaterial markerMaterial) {
            ...
            Entity entity = AssetAuthoringService.OwningCore.EntityFactory.Create("AxisTest2SunArrow");
            entity.LayerMask = SceneObjectsLayerMask;
