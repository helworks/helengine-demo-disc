...
namespace city.rendering.tools {
    ...
    /// </summary>
    public sealed class DepthClipProbeCenterMaterialFactory {
        /// <summary>
        /// Stable project-relative material path used by the depth-clip-probe scene's center box.
        /// </summary>
        public const string MaterialRelativePath = "materials/rendering/depth_clip_probe/DepthClipProbeCenterSolid.hasset";

        /// <summary>
        /// Stable serialized material asset identifier stored inside the generated material asset.
        /// </summary>
        public const string MaterialAssetId = "Materials.rendering.depth_clip_probe.DepthClipProbeCenterSolid";
        ...
        /// <summary>
        /// Stable mesh shader variant used by the depth-clip-probe center box solid-color path.
        /// </summary>
        const string MeshVariantName = "Mesh";

        /// <summary>
        /// Stable authored base color assigned to the depth-clip-probe center box, chosen to contrast against the surrounding blue box.
        /// </summary>
        const string CubeBaseColor = "#30ff60ff";
        ...
        /// <summary>
        /// Writes the file-backed depth-clip-probe center-box solid-color material asset and its platform settings into the supplied project.
        /// </summary>
        ...
        /// <summary>
        /// Builds the generated material definition that routes the depth-clip-probe center box through the shared lit forward shader with a flat green base color.
        /// </summary>
        /// <returns>Generated material definition for the depth-clip-probe center-box solid-color material.</returns>
