...
namespace city.rendering.tools {
    ...
    /// </summary>
    public sealed class DepthClipProbeMaterialFactory {
        /// <summary>
        /// Stable project-relative material path used by the depth-clip-probe scene.
        /// </summary>
        public const string MaterialRelativePath = "materials/rendering/depth_clip_probe/DepthClipProbeSolid.hasset";

        /// <summary>
        /// Stable serialized material asset identifier stored inside the generated material asset.
        /// </summary>
        public const string MaterialAssetId = "Materials.rendering.depth_clip_probe.DepthClipProbeSolid";
        ...
        /// <summary>
        /// Stable mesh shader variant used by the depth-clip-probe solid-color path.
        /// </summary>
        const string MeshVariantName = "Mesh";

        /// <summary>
        /// Stable authored base color assigned to the depth-clip-probe boxes, chosen to contrast against the white diagnostic overlay text.
        /// </summary>
        const string CubeBaseColor = "#3060ffff";
        ...
        /// <summary>
        /// Initializes one depth-clip-probe solid-color material factory.
        /// </summary>
        public DepthClipProbeMaterialFactory(IEditorProjectAuthoringSession assetAuthoringService, EditorAuthoringTransaction transaction) {
            MaterialWriteService = new GeneratedMaterialAssetWriteService(assetAuthoringService, transaction);
        }

        /// <summary>
        /// Writes the file-backed depth-clip-probe solid-color material asset and its platform settings into the supplied project.
        /// </summary>
        ...
        /// <summary>
        /// Builds the generated material definition that routes the depth-clip-probe boxes through the shared lit forward shader with a flat blue base color.
        /// </summary>
        /// <returns>Generated material definition for the depth-clip-probe solid-color material.</returns>
